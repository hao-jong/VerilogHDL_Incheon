...
HD_PWD='C:/FPGA_project/stopwatch_bhg/stopwatch_bhg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_cnt_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_cnt_test.tcl -notrace
