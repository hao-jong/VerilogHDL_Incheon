...
HD_PWD='C:/FPGA_project/stopwatch_bhg/stopwatch_bhg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_cnt_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex_cnt_test.tcl
