...
HD_PWD='C:/FPGA_project/my_mult/my_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_mult.tcl
