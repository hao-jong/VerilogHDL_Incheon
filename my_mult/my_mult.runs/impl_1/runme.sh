...
HD_PWD='C:/FPGA_project/my_mult/my_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_mult.tcl -notrace
