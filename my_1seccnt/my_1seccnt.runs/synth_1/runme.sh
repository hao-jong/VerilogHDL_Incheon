...
HD_PWD='C:/FPGA_project/my_1seccnt/my_1seccnt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_1seccnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_1seccnt.tcl
