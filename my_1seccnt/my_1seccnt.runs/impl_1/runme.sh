...
HD_PWD='C:/FPGA_project/my_1seccnt/my_1seccnt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_1seccnt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_1seccnt.tcl -notrace
