...
my_fsm my_fsm_0(.clk(clk),.rst(rst),.RXD(RXD),.CNT_542(CNT_542),.CNT_11(CNT_11),.CNT_542_rst(CNT_542_rst),.CNT_542_up(CNT_542_up),.CNT_11_rst(CNT_11_rst),.CNT_11_up(CNT_11_up),.sample(sample),.Rx_rdy(Rx_rdy));
