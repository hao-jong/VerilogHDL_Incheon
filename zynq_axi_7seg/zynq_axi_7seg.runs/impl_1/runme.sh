...
HD_PWD='C:/FPGA_project/zynq_axi_7seg/zynq_axi_7seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_7seg_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_axi_7seg_bd_wrapper.tcl -notrace
