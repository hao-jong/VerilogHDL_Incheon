...
HD_PWD='C:/FPGA_project/zynq_axi_7seg/zynq_axi_7seg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_7seg_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_7seg_bd_wrapper.tcl
