...
HD_PWD='C:/FPGA_project/zynq_axi_7seg/zynq_axi_7seg.runs/zynq_axi_7seg_bd_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_axi_7seg_bd_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_axi_7seg_bd_processing_system7_0_0.tcl
