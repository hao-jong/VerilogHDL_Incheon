...
HD_PWD='C:/FPGA_project/comb_lab/comb_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_2b_cyo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_2b_cyo.tcl
