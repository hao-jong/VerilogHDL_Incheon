...
HD_PWD='C:/FPGA_project/my_fsm/my_fsm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_fsm_ssd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_fsm_ssd.tcl
