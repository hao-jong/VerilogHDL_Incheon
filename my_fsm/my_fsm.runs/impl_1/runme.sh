...
HD_PWD='C:/FPGA_project/my_fsm/my_fsm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_fsm_ssd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_fsm_ssd.tcl -notrace
