...
HD_PWD='C:/FPGA_project/my_FSMsec/my_FSMsec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_security.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_security.tcl -notrace
