...
HD_PWD='C:/FPGA_project/my_FSMsec/my_FSMsec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_security.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_security.tcl
