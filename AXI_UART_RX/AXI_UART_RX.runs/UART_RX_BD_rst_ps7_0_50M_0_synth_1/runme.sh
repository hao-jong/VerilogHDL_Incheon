...
HD_PWD='C:/FPGA_project/AXI_UART_RX/AXI_UART_RX.runs/UART_RX_BD_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_BD_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_RX_BD_rst_ps7_0_50M_0.tcl
