...
HD_PWD='C:/FPGA_project/AXI_UART_RX/AXI_UART_RX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_RX_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_RX_BD_wrapper.tcl -notrace
