...
HD_PWD='C:/FPGA_project/my_numtossd/my_numtossd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt2ssd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_cnt2ssd.tcl -notrace
