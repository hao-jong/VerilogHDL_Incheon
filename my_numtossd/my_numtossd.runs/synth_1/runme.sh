...
HD_PWD='C:/FPGA_project/my_numtossd/my_numtossd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_cnt2ssd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_cnt2ssd.tcl
