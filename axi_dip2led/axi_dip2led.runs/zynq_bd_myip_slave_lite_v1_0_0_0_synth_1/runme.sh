...
HD_PWD='C:/FPGA_project/axi_dip2led/axi_dip2led.runs/zynq_bd_myip_slave_lite_v1_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_bd_myip_slave_lite_v1_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_bd_myip_slave_lite_v1_0_0_0.tcl
