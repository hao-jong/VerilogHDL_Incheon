...
HD_PWD='C:/FPGA_project/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_and.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_and.tcl -notrace
