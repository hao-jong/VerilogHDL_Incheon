...
HD_PWD='C:/FPGA_project/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_and.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_and.tcl
