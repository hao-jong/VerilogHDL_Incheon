...
HD_PWD='C:/FPGA_project/my_cnt3/my_cnt3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count3.tcl -notrace
