...
HD_PWD='C:/FPGA_project/my_4bit_adder/my_4bit_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_4bit_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_4bit_adder.tcl
