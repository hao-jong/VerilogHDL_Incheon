...
HD_PWD='C:/FPGA_project/my_4bit_adder/my_4bit_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_4bit_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_4bit_adder.tcl -notrace
