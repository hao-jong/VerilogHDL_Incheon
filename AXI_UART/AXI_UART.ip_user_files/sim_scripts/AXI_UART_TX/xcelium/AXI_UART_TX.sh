...
#
# Script generated by Vivado on Mon Jan 06 12:00:52 +0900 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : AXI_UART_TX.sh
...
#
# Usage        : AXI_UART_TX.sh
#                AXI_UART_TX.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                AXI_UART_TX.sh [-reset_run]
#                AXI_UART_TX.sh [-reset_log]
#                AXI_UART_TX.sh [-help]
#
...
#                script (type 'AXI_UART_TX.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_register_slice_v2_1_31 -libname axi_protocol_converter_v2_1_31 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 generic_baseblocks_v2_1_2 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_register_slice_v2_1_31 axi_protocol_converter_v2_1_31)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "AXI_UART_TX.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./AXI_UART_TX.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/ec67/hdl" +incdir+"../../../../AXI_UART.gen/sources_1/bd/AXI_UART_TX/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.AXI_UART_TX xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.AXI_UART_TX -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log AXI_UART_TX_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./AXI_UART_TX.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: AXI_UART_TX.sh [-help]\n\
Usage: AXI_UART_TX.sh [-step]\n\
Usage: AXI_UART_TX.sh [-lib_map_path]\n\
Usage: AXI_UART_TX.sh [-reset_run]\n\
Usage: AXI_UART_TX.sh [-reset_log]\n\
Usage: AXI_UART_TX.sh [-keep_index]\n\
Usage: AXI_UART_TX.sh [-noclean_files]\n\n\
