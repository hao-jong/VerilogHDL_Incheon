...
HD_PWD='C:/FPGA_project/my_coraz7/my_coraz7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_blockdesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_blockdesign_wrapper.tcl
