...
HD_PWD='C:/FPGA_project/my_coraz7/my_coraz7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_blockdesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_blockdesign_wrapper.tcl -notrace
