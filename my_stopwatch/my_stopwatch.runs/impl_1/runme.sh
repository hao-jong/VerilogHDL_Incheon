...
HD_PWD='C:/FPGA_project/my_stopwatch/my_stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_stopwatch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source my_stopwatch.tcl -notrace
