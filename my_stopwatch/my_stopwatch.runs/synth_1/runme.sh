...
HD_PWD='C:/FPGA_project/my_stopwatch/my_stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_stopwatch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_stopwatch.tcl
